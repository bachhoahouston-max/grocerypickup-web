      ...
      <>
        <div className="bg-[url('/download2.png')] bg-cover bg-no-repeat md:h-[580px] w-full md:p-0 p-5">
          <div className="flex items-center justify-start h-full w-full max-w-7xl mx-auto">
            <div className="flex flex-col justify-center items-start bg-[#F3DDCD] w-full md:w-[550px] h-auto md:h-[220px] px-8 py-12">
              <div className="flex">
              ...
              {t("Enjoy 35% off on fresh, organic groceries – clean, healthy, and chemical-free, straight from trusted farms")}.
              </p>
            </div>
          </div>
        </div>
