...
const AboutUs = () => {
  ...
  return (
    ...
    <div className=" w-full bg-green-100 mx-auto flex flex-col md:flex-row justify-center items-center ">
      <div className="  py-16 w-[780px] h-[675px] ps-24">
        <nav className="mb-4 mt-14 text-[12px]">
          <span className="text-gray-600 mr-1" >
            Home /
          </span>
          
          <span className="text-[#FEC200] " >
            About us
          </span>
        </nav>
        <h1 className=" mt-12 text-3xl leading-[50px] font-bold text-gray-800 mb-4 w-[60%] text-[30px]">
          Lorem Ipsum is simply dummy text of the printing and.
        </h1>
        <p className="text-gray-600 mb-6 text-[15px] leading-[32px] w-[70%]">
      ...
      <div className="container mx-auto py-12 px-20">
        ...
        <div className="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-8 ">
          <div className="bg-white px-8 py-12 rounded-lg shadow-lg">
            <div className="bg-purple-100 text-purple-600 px-8 py-2 rounded-full inline-block mb-4">Lorem Ipsum</div>
          ...
          <div className="bg-white px-8 py-12 rounded-lg shadow-lg">
            <div className="bg-red-100 text-red-600 px-8 py-2 rounded-full inline-block mb-4">Lorem Ipsum</div>
            <h3 className="text-xl font-semibold mb-4 text-black">Lorem Ipsum</h3>
            <p className="text-gray-600 w-[90%]">Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
          </div>
          <div className="bg-white px-8 py-12 rounded-lg shadow-lg">
            <div className="bg-green-100 text-custom-green px-8 py-2 rounded-full inline-block mb-4">Lorem Ipsum</div>
            <h3 className="text-xl font-semibold mb-4 text-black">Lorem Ipsum</h3>
            <p className="text-gray-600 w-[90%]">Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
          </div>
        </div>
    ...
    <div className="">
      <div className="w-full bg-green-100 mx-auto h-full">
        <div className=" px-24 rounded-lg flex flex-col md:flex-row gap-20">
          ...
          <div className="md:w-2/3 md:pl-6 mt-4 md:mt-0 flex flex-col justify-center gap-4">
            ...
            <h1 className="text-2xl md:text-[28px] font-bold mt-2 w-[60%] text-black ">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            </h1>
            <p className="text-gray-700 mt-4 text-[16px] w-[70%]">
    ...
    <div className="bg-white ">
      ...
      <div className="mb-20 ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  gap-6 ">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-[#F5F5F5] flex flex-col justify-center items-center p-4 rounded-[20px] w-[295px] h-[253px] shadow">
      ...
      <div className="bg-[#F5F5F5]">
        <div className="max-w-7xl container mx-auto "> 
      <h2 className="text-xl font-semibold mb-14 pt-14 text-black">Our Services</h2>
       
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pb-20">
          {services.map((service, index) => (
            <div key={index} className="bg-custom-green rounded-[18px] w-[263px] h-[218px] p-4 text-black text-center flex justify-center flex-col items-center">
              <img src="icon-3.png"/>
